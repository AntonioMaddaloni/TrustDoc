...
static const oe_ecall_info_t _trustdoc_ecall_info_table[] = 
{
    { "compute_sha256" },
...
oe_result_t trustdoc_compute_sha256(
    ...
    size_t hash_size)
{
    ...
    /* Marshalling struct. */
    compute_sha256_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.hash = (uint8_t*)hash;
    _args.hash_size = hash_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(compute_sha256_args_t));
    if (data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.data_size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(compute_sha256_args_t));
    if (hash)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, _args.hash_size);
    ...
    _pargs_in = (compute_sha256_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (data)
        OE_WRITE_IN_PARAM(data, 1, _args.data_size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_compute_sha256].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (compute_sha256_args_t*)_output_buffer;
    ...
    OE_READ_OUT_PARAM(hash, 1, _args.hash_size);
...
OE_WEAK_ALIAS(trustdoc_compute_sha256, compute_sha256);

oe_result_t trustdoc_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(trustdoc_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t trustdoc_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(trustdoc_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t trustdoc_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(trustdoc_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t trustdoc_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(trustdoc_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t trustdoc_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _trustdoc_ecall_info_table[trustdoc_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(trustdoc_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _trustdoc_ocall_function_table[] = {
...
oe_result_t oe_create_trustdoc_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _trustdoc_ocall_function_table,
               87,
               _trustdoc_ecall_info_table,
                6,
               enclave);
}
